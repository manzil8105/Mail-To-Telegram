...
2. Turn on the 2FA(2 factor authentication) of the mail you want to use.
3. Go to this { https://ln.run/wb-i0 } and make a new app password, name it whatever you want, and you will get a 16-character pass. Keep it secure and only to yourself
4. Now for the telegram bot. Search @BotFather on telegram, start a conversation, type /start, type /newbot. Then it will ask for your bot name, give a name of your choosing, and then it will ask you to  choose a username for your bot. It must end in `bot`. Like this, for example: TetrisBot or tetris_bot. After all this, the botfather will send you a token. Secure the token.
5. Now, search @userinfobot , type /start, and it will provide you with an id number along with your username. Secure the id number.
